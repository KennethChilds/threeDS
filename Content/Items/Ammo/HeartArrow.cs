...
namespace threeDS.Content.Items.Ammo
{
	...
	public class HeartArrow : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 4; // Keep in mind that the arrow's final damage is combined with the bow weapon damage.
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.HeartArrowProjectile>(); // The projectile that weapons fire when using this item as ammunition.
